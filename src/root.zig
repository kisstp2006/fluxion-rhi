...
pub const Dimension = types.Dimension;
pub const Subresource = types.Subresource;
pub const TextureRegion = types.TextureRegion;
pub const TextureInfo = types.TextureInfo;
pub const MipFilter = types.MipFilter;
pub const BorderColor = types.BorderColor;
pub const mipExtent = types.mipExtent;
pub const fullMipCount = types.fullMipCount;
...
pub const ShaderWords = types.ShaderWords;
